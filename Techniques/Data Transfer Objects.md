Data Transfer Objects or DTO's are objects used in [[API|API's]] to transfer data. They are exposed to the client or the user of the website, allowing the actual objects to be hidden. 
